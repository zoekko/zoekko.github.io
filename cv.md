<div class="cv-container" style="text-align: left;">
  ...
  <p>zko2@jh.edu · ORCID: 0000-0002-4962-2543</p>
  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        <li>Developed a laser detection algorithm to search for potential technosignatures in optical stellar spectra and applied algorithm to over 1,000 spectra of nearby stars to set detection limits.</li>
      </ul>
    </li>
    <li>
      ...
      <ul>
        <li>Designed a pipeline from scratch to detect radial velocity variations through cross-correlation techniques and applied pipeline to 28 candidate binary star systems.</li>
      </ul>
    </li>
  </ul>
  ...
  <ul>
    ...
    <li>
      <strong>Fulbright Scholarship Award</strong><br>
  ...
  <h2>Skills</h2>
  <ul>
    <li><strong>Programming:</strong> Advanced proficiency in Python (NumPy, SciPy, pandas, matplotlib, Astropy, etc.), Java, R.</li>
